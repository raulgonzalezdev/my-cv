    ...
    experience: [
      {
        ...
        projects: [
          ...
          },
          {
            name: 'Ally Mobile',
            description:
              'Trabajé en el desarrollo de Ally Mobile, una aplicación en React Native...'
          }
        ]
      },
      {
        ...
        location: 'Venezuela',
        description:
          'Como fundador y CEO de Syswin Limited, C.A., desempeñé múltiples roles...',
        projects: [
          {
            name: 'Datqbox Administrativo',
            description:
              'Desarrollo y liderazgo del proyecto Datqbox Administrativo, un software propietario de la empresa...'
          }
        ]
      }
    ],
